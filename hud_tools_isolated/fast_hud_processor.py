...
class FastHUDProcessor:
    ...
    async def process_tank_fast(self, tank: Dict) -> Dict:
        ...
        tank_data = {
            ...
            'has_dike': has_dike,
            'dike_length': tank.get('dike_dims', [None, None])[0] if has_dike and tank.get('dike_dims') else None,
            'dike_width': tank.get('dike_dims', [None, None])[1] if has_dike and tank.get('dike_dims') else None
        }
